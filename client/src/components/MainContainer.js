...
function mapStateToProps(state) {
  return {
    ...
    elect_value: state.main.elect_value,
    recipe_data: state.main.recipe_data
  }
}
...
function mapDispatchToProps(dispatch) {
  return {
    ...
    getElectValue: (value, id) => dispatch(getElectValue(value, id)),
    getElectFromRecipe: (value) => dispatch(getElectFromRecipe(value)),
    loadRecipeData: (value) => dispatch(loadRecipeData(value)),
  }
}
