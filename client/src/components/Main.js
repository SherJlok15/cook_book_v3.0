            ...
            <Route exact path='/recipes/:id'
              render={(props) =>
                <Recipe{...props}
                  ...
                  navbarSearchValue={this.props.navbarSearchValue}
                  toggleElectValue={this.props.toggleElectValue}
                  getElectValue={this.props.getElectValue}
                  getElectFromRecipe={this.props.getElectFromRecipe}
                  loadRecipeData={this.props.loadRecipeData}
                  recipe_data={this.props.recipe_data}
                  />
              }/>
